...
export class PostService{
    ...
    getAllPost(): Observable<ResponseEnity<Post[]>>{
        ...
        return this.http.get<ResponseEnity<Post[]>>(Constant.API_URL +  this.URL_GET_ALL_POST);
    }
    getPostById(id: number): Observable<ResponseEnity<Post>>{
        return this.http.get<ResponseEnity<Post>>(Constant.API_URL + this.URL_GET_POST_BY_ID + id);
    }
    addPost(post: Post): Observable<ResponseEnity<Post>>{
        return this.http.post<ResponseEnity<Post>>(Constant.API_URL + this.URL_INSERT_PUT_POST, post);
    }
    updatePost(post: Post): Observable<ResponseEnity<Post>>{
        return this.http.put<ResponseEnity<Post>>(Constant.API_URL + this.URL_INSERT_PUT_POST, post);
    }
    deletePost(id: number): Observable<ResponseEnity<Post>>{
        return this.http.delete<ResponseEnity<Post>>(Constant.API_URL + this.URL_DELETE_POST_BY_ID + id);
    }
}
